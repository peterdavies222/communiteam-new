...
class ExploreView {
  async init(){
    ...
    window.addEventListener('resize', this.mapVisibilities)
  }
  ...
  buttonToggles() {
    ...
    let mapBtn = document.querySelector('button.map')
    ...
    listBtn.addEventListener('click', () => {
      ...
      document.querySelector('.explore__events').style.display = 'block'
      document.querySelector('.explore__map').style.display = 'none'
    })

    mapBtn.addEventListener('click', () => {
      mapBtn.classList.add('active')
      listBtn.classList.remove('active')
      document.querySelector('.explore__events').style.display = 'none'
      document.querySelector('.explore__map').style.display = 'block'
    })
  }

  mapVisibilities() {
    let mapDesktop = document.querySelector('.explore__map.desktop-only')
    let mapMobile = document.querySelector('.explore__map.mobile-only')
    if(window.innerWidth <= 1024) {
      mapDesktop.setAttribute('aria-hidden', 'true')
      mapMobile.setAttribute('aria-hidden', 'false')
    } else {
      mapDesktop.setAttribute('aria-hidden', 'false')
      mapMobile.setAttribute('aria-hidden', 'true')
    }
  }
    ...
    <header>
      ...
      <main class="explore main-content horizontal">
        ...
        <div class="explore__content">
          ...
          <div class="mobile-only button-group">
          ...
          <div class="explore__map mobile-only">
        ...
        <div class="explore__map desktop-only">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3383.3
          56154914758!2d115.88940687587879!3d-32.0054648739957!2m3!1f0!2f0!3f0!3m2!1i
          1024!2i768!4f13.1!3m3!1m2!1s0x2a32bc6b85869af3%3A0x8623a5870014444e!2sCurti
          n%20University!5e0!3m2!1sen!2sau!4v1747650969520!5m2!1sen!2sau" width="100%"
