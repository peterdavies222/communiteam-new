...
customElements.define('ct-nav', class Communiteam extends LitElement {
  ...
  render(){    
    ...
    <style>
      * {
      ...
      /* .nav__link.highlighted {
        ...
        box-shadow: 0 0 0 2px var(--ct-green), 0 0 0 4px var(--ct-yellow);
      } */
    ...
    <nav class="nav--desktop">
      ...
      <a href="/dashboard" @click="${this.menuClick}"><img src="/images/logo.svg" alt="Communiteam."></a>
      <ul class="nav__links">
        ...
        <li>
          <sl-dropdown>
            ...
            <sl-menu>
              ...
              <sl-menu-item><a href="/myEvents/newEvent" class="nav__link highlighted" @click="${this.menuClick}">${postIcon}Post new event</a></sl-menu-item>
            </sl-menu>
          </sl-dropdown>
        </li>
    ...
    <nav class="nav--mobile">
      <div class="nav--mobile--upper">
        <a href="/dashboard" @click="${this.menuClick}"><img class="nav__logo" src="/images/logo.svg" alt="Communiteam."></a>
